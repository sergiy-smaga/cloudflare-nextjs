...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10">
      <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-4 w-full max-w-2xl mb-6">
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-red-700 dark:text-red-300">
              <p>
                We could not load this user profile. The user may not exist or
